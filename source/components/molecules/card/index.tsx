...
const Card: React.FC<CardProps> = ({card}) => {
  ...
  return (
    <CardStyle.Container
      onPress={() =>
        navigation.navigate('RepositoriesOfUsers', {login: card.login})
      }>
      ...
      <Row>
        <GridRow justify="flex-start">
          <Row
            ...
            <CardStyle.Informations numberOfLines={1}>
              {card?.company}
          ...
          <Row
            ...
            <CardStyle.Informations numberOfLines={1}>
              {card?.starredRepositories?.totalCount || 0}
            </CardStyle.Informations>
          </Row>
        </GridRow>
      </Row>
